...
-- ----------------------------
-- Table structure for sys_program_user
-- ----------------------------
DROP TABLE IF EXISTS `sys_program_user`;
CREATE TABLE `sys_program_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `program_id` int(11) DEFAULT NULL COMMENT '程序ID',
  `program_appid` varchar(100) DEFAULT NULL COMMENT '程序appid',
  `program_name` varchar(32) DEFAULT NULL COMMENT '程序名称',
  `openid` varchar(100) DEFAULT NULL COMMENT 'openid',
  `unionid` varchar(100) DEFAULT NULL COMMENT 'unionid',
  `phone` varchar(20) DEFAULT NULL COMMENT '手机号码',
  `nickname` varchar(255) DEFAULT NULL COMMENT '昵称',
  `program_code` varchar(100) DEFAULT NULL COMMENT '程序编码',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='程序用户表';

-- ----------------------------
-- Records of sys_program_user
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统角色表';
