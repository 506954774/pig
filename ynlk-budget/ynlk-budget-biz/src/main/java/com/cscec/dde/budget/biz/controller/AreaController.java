package com.cscec.dde.budget.biz.controller;

import cn.hutool.core.bean.BeanUtil;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.cscec.dde.budget.api.dto.AddOscAreaDTO;
import com.cscec.dde.budget.api.dto.QueryPageDTO;
import com.cscec.dde.budget.api.entity.OscArea;
import com.cscec.dde.budget.biz.exceptions.BizException;
import com.cscec.dde.budget.biz.service.IOscAreaService;
...
public class AreaController {
	...
	@PostMapping("/add")
	public R<Integer> save(  @RequestBody @Valid AddOscAreaDTO dto) {
	...
	@DeleteMapping("/{id}" )
	public R<Integer> removeById(@PathVariable Integer id) {
	 ...
	 *  查询地区列表(国家/地区列表)
	 *
	 * @returnhttps://github.com/506954774/pig.git
	 */
	@ApiOperation(value = " 查询地区列表(国家/地区列表)", notes = " 查询地区列表(国家/地区列表)")
	@PostMapping("/page")
	public R<Page<OscArea>> page(@RequestBody @Valid QueryPageDTO dto) {
		if(dto==null){
